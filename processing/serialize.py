...
def main():
    ...
    parser.add_argument("--input", default=str(script_dir / "doterra_oils_sitemap.csv"), help="Input CSV file")
    parser.add_argument("--output", default=str(script_dir / "single_oil.csv"), help="Output CSV file")
