...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        if not exists:
            print(f"Warning: Collection '{QDRANT_COLLECTION}' does not exist yet. Please run ingestion.")
        else:
...
class ProductPayload(BaseModel):
    product_name: str
    product_sub_name: Optional[str] = None
    product_image_url: Optional[str] = None
    product_description: Optional[str] = None
    brand_lifestyle_title: Optional[str] = None
    brand_lifestyle_description: Optional[str] = None
